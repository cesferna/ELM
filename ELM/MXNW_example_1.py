...
path_file_WE = path_base+"/settings/M-XNW/"+stock+"/"+stock+"_"+wavelet+"_network_setting.csv"
path_file_ELM = path_base+"/settings/M-XNW/"+stock+"/"+stock+"_network_setting.csv"
path_betas = path_base+"/settings/M-XNW/"+stock+"/"+"betas.csv"
...
for i in range(len(elm_tst_patterns)):
    ...
    lp          = elm_tst_patterns[i][-1] 
    output      = elm_predict*betas[1] + we_predict*betas[0]  + betas[2]*lp + betas[3]
